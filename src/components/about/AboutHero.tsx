            ...
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                <p className="relative mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                  Book your favorite sports venues in just a few clicks. Whether
                  it's football, basketball, tennis, or any other sport, we make
                  it easy to reserve your spot. Say goodbye to the hassle of
                  finding a place to play—your game is just a booking away.
                </p>
              </div>
