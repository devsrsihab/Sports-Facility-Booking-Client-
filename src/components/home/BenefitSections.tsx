...
const BenefitSections = () => {
  return (
    <section
      ...
      data-component-id="38fd3fdd_14_awz"
      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap pb-12 border-b border-gray-50 mb-8">
          <div className="w-full lg:w-1/2 p-4">
            <h1
              className="font-heading text-rhino-700 text-5xl font-semibold mb-6"
              data-config-id="txt-20c658-1"
            >
              Lorem ipsum dolor sit amet consectetur
            </h1>
            <p
              className="text-rhino-300 text-lg max-w-lg leading-7"
              data-config-id="txt-20c658-2"
            >
        ...
        <div className="flex flex-wrap">
          <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p
                  className="text-rhino-500 font-semibold"
                  data-config-id="txt-20c658-3"
                >
                  Free Shipping
                </p>
                <p
                  className="text-rhino-400 text-sm font-medium"
                  data-config-id="txt-20c658-4"
                >
                  From $45
                </p>
              </div>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p
                  className="text-rhino-500 font-semibold"
                  data-config-id="txt-20c658-5"
                >
                  Secure Shopping
                </p>
                <p
                  className="text-rhino-400 text-sm font-medium"
                  data-config-id="txt-20c658-6"
                >
                  100% Guarantee
                </p>
              </div>
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p
                  className="text-rhino-500 font-semibold"
                  data-config-id="txt-20c658-7"
                >
                  Customer Satisfaction
                </p>
                <p
                  className="text-rhino-400 text-sm font-medium"
                  data-config-id="txt-20c658-8"
                >
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 p-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p
                  className="text-rhino-500 font-semibold"
                  data-config-id="txt-20c658-9"
                >
                  Support
                </p>
                <p
                  className="text-rhino-400 text-sm font-medium"
                  data-config-id="txt-20c658-10"
                >
                  Online Support 24/7
                </p>
              </div>
