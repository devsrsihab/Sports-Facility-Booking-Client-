      ...
      <div className="mx-auto max-w-2xl px-4 py-8  sm:px-6 lg:max-w-7xl lg:px-8">
        <div>
          ...
          <Link to={`/facilities/${facilitie._id}`}>
            <div className="mt-6">
              <span className="relative flex items-center justify-center rounded-md border border-transparent bg-gray-100 py-2 px-8 text-sm font-medium text-gray-900 hover:bg-gray-200">
                View Details
              </span>
            </div>
          </Link>
